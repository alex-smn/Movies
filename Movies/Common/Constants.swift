...
struct Constants {
    ...
    static let apiAccountUrl = "https://api.themoviedb.org/3/account"
    static let apiTrendingUrl = "https://api.themoviedb.org/3/trending/all/"
    static let apiMovieSearchUrl = "https://api.themoviedb.org/3/search/movie"
    static let apiTVSearchUrl = "https://api.themoviedb.org/3/search/tv"
    static let apiPersonSearchUrl = "https://api.themoviedb.org/3/search/person"
